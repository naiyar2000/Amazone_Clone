...
var IndexedDbComponentProvider = /** @class */ (function (_super) {
    ...
    IndexedDbComponentProvider.prototype.clearPersistence = function (databaseId, persistenceKey) {
 ...
 */
var MultiTabIndexedDbComponentProvider = /** @class */ (function (_super) {
    tslib.__extends(MultiTabIndexedDbComponentProvider, _super);
    function MultiTabIndexedDbComponentProvider() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    MultiTabIndexedDbComponentProvider.prototype.initialize = function (cfg) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _this = this;
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.persistence.setPrimaryStateListener(function (isPrimary) { return tslib.__awaiter(_this, void 0, void 0, function () {
                                return tslib.__generator(this, function (_e) {
                                    switch (_e.label) {
                                        case 0: return [4 /*yield*/, applyPrimaryState(this.syncEngine, isPrimary)];
                                        case 1:
                                            _e.sent();
                                            if (this.gcScheduler) {
    ...
    MultiTabIndexedDbComponentProvider.prototype.createSyncEngine = function (cfg) {
        var startsAsPrimary = !cfg.persistenceSettings.durable ||
            !cfg.persistenceSettings.synchronizeTabs;
        var syncEngine = newSyncEngine(this.localStore, this.remoteStore, this.datastore, this.sharedClientState, cfg.initialUser, cfg.maxConcurrentLimboResolutions, startsAsPrimary);
    ...
    MultiTabIndexedDbComponentProvider.prototype.createSharedClientState = function (cfg) {
        if (cfg.persistenceSettings.durable &&
            cfg.persistenceSettings.synchronizeTabs) {
    ...
    return MultiTabIndexedDbComponentProvider;
...
function registerFirestore(instance) {
    configureForFirebase(instance, function (app, auth) { return new Firestore(app, auth, new MultiTabIndexedDbComponentProvider()); });
